  ...
  <div id="site-navigation" class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    <div class="navbar-inner">
      <div class="container">
        ...
        <a href="<?php echo esc_url( home_url( '/' ) ); ?>" class="brand"><img class="img-responsive" alt="Brand" src="img/CMAG_white200.png"></a>
        ...
        <div class="navtext">
            ...
            <form method="get" id="search" class="navbar-search pull-right" action="<?php bloginfo('home'); ?>/">
                <div id="label"><label for="search-terms" id="search-label">search</label></div>
                <div id="input"><input type="text" name="search-terms" id="search-terms" placeholder="Pesquisar" class="search-query"
                  onfocus="if(this.value==this.defaultValue)this.value='';" onblur="if(this.value=='')this.value=this.defaultValue;" x-webkit-speech tabindex="1"></div>
            </form>
  			...
  			<div>
  				<form class="form-search navbar-form">
  					<input type="text" name="s" id="s" class="search-query" placeholder="Pesquisa" onfocus="if(this.value==this.defaultValue)this.value='';" onblur="if(this.value=='')this.value=this.defaultValue;" x-webkit-speech tabindex="1">
  				</form>
  			</div>
  			</form>
        </div>
